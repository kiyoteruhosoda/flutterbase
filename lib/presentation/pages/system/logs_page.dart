...
class _LogsPageState extends ConsumerState<LogsPage> {
  ...
  /// The buffer is not Riverpod state — it lives in the logger and changes
  /// without telling anyone — so the screen reads it on every build and calls
  /// `setState` after clearing it.
