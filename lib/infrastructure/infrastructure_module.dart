...
/// store, restoring the saved log level, opening the first log file — so that
/// the composition root never has to name a storage technology. That is what
/// keeps `SharedPreferences`, `dart:io`, and friends confined to this layer,
/// which `tool/check_architecture.dart` verifies.
